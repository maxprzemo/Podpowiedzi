...
echo "|Telefon : $Model                                                                                      "
echo "-------------------------------------------------------------------------------------------------------"
echo "|Chrome             |Keep                |Tapatalk           |Gmail               |Razem               |"
echo "-------------------------------------------------------------------------------------------------------"
echo "|Czas               |Czas                |Czas               |Czas                |Czas                |"
echo "-------------------------------------------------------------------------------------------------------"
...
Pstart=1
#-------------------------------------------------------------------------------------------------------------------------------------------
Pkoniec=2  # <<<<<<<<<<<<<<< Tu wpisz wartość końcową. Wykona się tyle pomiarów dla każdej aplikacji ile jest w tej wartości
#-------------------------------------------------------------------------------------------------------------------------------------------
...
echo "-------------------------------------------------------------------------------------------------------"
echo "|Średnio            |Średnio             |Średnio            |Średnio             |Średnio             |"
echo "-------------------------------------------------------------------------------------------------------"
